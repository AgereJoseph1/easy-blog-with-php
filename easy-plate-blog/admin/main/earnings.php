			...
			<div class="row">
				...
				<div class="col-lg-12 col-12 my-25">
						<div class="box pull-up">
							<div class="box-body bg-img py-md-10" style="background-image: url(../images/bg-5.png);" data-overlay-light="9">
								<div class="d-lg-flex align-items-center justify-content-between">
									<div class="d-md-flex align-items-center mb-30 mb-lg-0 w-p100">
										<img src="https://www.multipurposethemes.com/admin/eduadmin-template/images/svg-icon/color-svg/custom-14.svg" class="img-fluid max-w-300" alt="" />
										<div class="ml-30">
											<h4 class="mb-10">Earn Money Easily Through Blogging !</h4>
											<p class="mb-0 text-fade">This page is under construction but before then take a look <br>at how to write excellent blogs <a href="comming_soon.html"><u>here</u></a> </p>
										</div>
									</div>
								</div>							
							</div>
