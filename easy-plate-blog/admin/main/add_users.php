						...
						<div class="box-body pr-0 pl-lg-50 pl-15 py-0">
							<div class="row align-items-center">
								<div class="col-12 col-lg-8">
									<h1 class="font-size-40 text-white">Add User!</h1>
									<p class="text-white mb-0 font-size-20">
										Add new users and earn 20 coins per refereral
									</p>
								</div>
								<div class="col-12 col-lg-4"><img src="../images/custom-15.svg" alt=""></div>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-10 col-12">
					  <div class="box">
						<div class="box-header with-border">
						  <h4 class="box-title">Complete the Form</h4>
						</div>
						<!-- /.box-header -->
						<form class="form">
							<div class="box-body">
								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="form-group">
										  <label>Address</label>
										  <textarea rows="3" class="form-control" placeholder="About Project"></textarea>
										</div>
									</div>
								</div>
							</div>
