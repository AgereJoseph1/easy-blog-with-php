		...
		<section class="content">
			<div class="box">
				<div class="box-header with-border">
				  <h4 class="box-title text-center">Choose a Template for your Email</h4>          
				</div>
			 </div>
			...
			<div class="row">
				  ...
				  <div class="box">
					<div class="box-header">
						...
						<div class="box-controls pull-right">
							<input name="group1" type="radio" class="with-gap" id="radio_3" data-toggle="modal" data-target="#defaultEmail" />
							<label for="radio_3"></label>
						</div>
					</div>
					<div class="box-body">
						<a class="d-block" href="inc/email_update.php" target="_blank">
				...
				<div class="col-md-12 col-lg-4">
				  <div class="box">
					<div class="box-header">
						...
						<div class="box-controls pull-right">
							<input name="group1" type="radio" class="with-gap" id="radio_4" data-toggle="modal" data-target="#welcomeEmail"/>
							<label for="radio_4"></label>
						</div>
					</div>
					<div class="box-body">
						<a class="d-block" href="inc/email_welcome.php" target="_blank">
				...
				<div class="col-md-12 col-lg-4">
				  <div class="box">
					<div class="box-header">
						<h4 class="box-title">Premium (disabled)</h4>
						<div class="box-controls pull-right">
							<input name="group1" type="radio" class="with-gap" id="radio_5" disabled="" data-toggle="modal" data-target="#premiumEmail"/>
		  ...
		  <!-- Default Modal -->
		  <div class="modal modal-fill fade" data-backdrop="false" id="defaultEmail" tabindex="-1">
			  ...
			  <div class="modal-content">
			    ...
			    <div class="modal-body mt-md-20 pt-md-20">
      				<h1 class="box-title my-md-4 text-center">Update(default) Email Template</h1>
			      <!-- form starts -->
			      <form action="" method="post">
			        ...
			        <div class="row mb-md-35">
			          ...
			          <div class="col-md-5">
			            <div class="input-group date">
			              ...
			              <input type="url" class="form-control pull-right">
			            </div>
			          </div>
			        </div>
			        ...
			        <textarea class="textarea" placeholder="Enter the blog content " style="width: 100%; height: 2s00px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>

			        <div class="row my-md-4">
			        	<div class="col-md-6">
		        			<input name="allsub" type="radio" class="with-gap" id="radio_1" />
							<label for="radio_1">To All My Subscribers</label>
			        	</div>
			        	<div class="col-md-6">
		        			<input name="allsub" type="radio" class="with-gap" id="radio_2" />
							<label for="radio_2">To Specific Subscribers</label>
			        	</div>
			        </div>
  		  ...
  		  <!-- Welcome Modal -->
		  <div class="modal modal-fill fade" data-backdrop="false" id="welcomeEmail" tabindex="-1">
			  <div class="modal-dialog modal-lg .modal-dialog-scrollable">
			  <div class="modal-content">
			    <div class="modal-header">
			    <button type="button" class="close" data-dismiss="modal">
			    ...
			    <div class="modal-body mt-md-20 pt-md-20">
      				<h1 class="box-title my-md-4 text-center">Welcome Email Template</h1>
			      <!-- form starts -->
			      <form action="" method="post">
			        <div class="form-group my-md-35">
			          <br><br><br><br>
			        ...
			        <div class="row mt-35">
			          <div class="col-md-6">
			            <label>Link to redirect to your page</label>
			          </div>
			        </div>
		            <div class="input-group date">
		              <div class="input-group-addon">
		              ...
		              <input type="url" class="form-control pull-right" placeholder="https://easyplateblogs.username.com">
		            </div>

		            <div class="row my-md-4">
			        	<div class="col-md-6">
		        			<input name="allsub" type="radio" class="with-gap" id="radio_8" />
							<label for="radio_8">To All My Subscribers</label>
			        	</div>
			        	<div class="col-md-6">
		        			<input name="allsub" type="radio" class="with-gap" id="radio_9" />
							<label for="radio_9">To Specific Subscribers</label>
			        	</div>
			        </div>
